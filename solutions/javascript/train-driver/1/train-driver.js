...
export function fixListOfWagons(ids) {
 ...
 /* Aquí el spread lo que hace es "esparcir" los números del array, los pone fuera
  * Si pusiera restWagons estaría metiendo un array dentro de otro:
  * [[restWagons], firstWagon, secondWagon] */ 
